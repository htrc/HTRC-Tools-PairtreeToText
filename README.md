[![Scala CI](https://github.com/htrc/HTRC-Tools-PairtreeToText/actions/workflows/ci.yml/badge.svg)](https://github.com/htrc/HTRC-Tools-PairtreeToText/actions/workflows/ci.yml)
